...
String prodId = request.getParameter("inCart.productId");
String quantity = request.getParameter("inCart.quantity");
String prodPrice = request.getParameter("inCart.price");
...
// Update total amount for order record
	...
	String sql3 = "UPDATE ordersummary SET totalAmount = SUM(orderproduct.quantity) FROM orderproduct JOIN ordersummary ON orderproduct.orderId = ordersummary.orderId";
